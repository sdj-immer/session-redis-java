...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static boolean isSmsCode(String code){
        Matcher matcher = smspattern.matcher(code);
        return  matcher.matches();
    }
    public static String subStringMobileFromTo(String mobile,int start,int length){
        return mobile.substring(0,start)+"****"+mobile.substring(start+length);
    }
